...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8029)), "/media/smarthagar/Assets/Project/NextJS/UMUM/my-portfolio/src/app/login/page.tsx"],
    ...
    const pages = ["/media/smarthagar/Assets/Project/NextJS/UMUM/my-portfolio/src/app/login/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 133))
...
;// CONCATENATED MODULE: ./src/store/auth/login.ts
/** @format */ 



const useLogin = (0,esm/* create */.Ue)((0,middleware/* devtools */.mW)((set, get)=>({
        setToken: ()=>{
        ...
        setLogin: async (data)=>{
            try {
                const response = await (0,baseURL/* auth */.I8)({
                    method: "post",
                    url: `/login`,
                    data
                });
...
/* harmony default export */ const login = (useLogin);
...
const Login = (props)=>{
    ...
    const fetchAuth = async ()=>{
        const token = js_cookie/* default.get */.Z.get("token");
    ...
    const onSubmit = async (e)=>{
        ...
        if (status === "success") {
            js_cookie/* default.set */.Z.set("token", data.token);
            router.push("/admin");
        }
    };
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: isLoading ? /*#__PURE__*/ jsx_runtime_.jsx("div", {
            ...
            className: "flex h-full lg:w-[80%] justify-center items-center",
            children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "bg-black px-8 py-4 rounded-lg shadow-lg shadow-secondary",
                children: /*#__PURE__*/ jsx_runtime_.jsx("form", {
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: "flex items-baseline justify-between mt-6",
                                children: /*#__PURE__*/ jsx_runtime_.jsx("button", {
                                    className: "px-6 py-2 text-white bg-primary rounded-lg hover:bg-secondary",
                                    children: "Login"
                                })
                            })
                        ]
...
/* harmony default export */ const page = (Login);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/media/smarthagar/Assets/Project/NextJS/UMUM/my-portfolio/src/app/login/page.tsx`)
